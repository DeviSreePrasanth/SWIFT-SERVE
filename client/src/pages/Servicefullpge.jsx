...
function ServiceFullPage() {
  ...
  const { category, service, vendor } = state || {}; // Destructure category, service, and vendor
  ...
  useEffect(() => {
    if (!service || !vendor) {
      navigate('/services'); // Redirect if service or vendor is missing
    } else {
    ...
    <div className="dark bg-gray-900 min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="relative mb-16 sm:mb-20">
            ...
            <div className="text-center">
              ...
              <p className="text-lg sm:text-xl text-gray-300 max-w-2xl mx-auto">
                Powered by <span className="font-bold text-blue-400">{vendor.name}</span> — Professional Excellence
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 sm:gap-12">
            ...
            <div className="relative lg:col-span-2 space-y-8">
              {/* Service Image */}
              <div className="relative h-[400px] sm:h-[500px] rounded-3xl overflow-hidden border-2 border-gray-700/50 backdrop-blur-lg bg-gradient-to-br from-gray-800/50 to-gray-900/70 shadow-xl">
                {service.imageUrl && (
                  <img
                ...
                {/* Floating Tag */}
                <div className="absolute -top-3 -right-3 sm:-top-4 sm:-right-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-4 py-2 sm:px-6 sm:py-3 rounded-xl shadow-2xl z-20 flex items-center">
                  <span className="font-bold text-xs sm:text-sm">⭐ Top Rated</span>
                </div>
              </div>
              ...
              <div className="bg-gray-800/30 border-2 border-gray-700/30 rounded-3xl p-6 sm:p-8 backdrop-blur-lg shadow-2xl">
                ...
                <div className="space-y-6">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl font-bold text-white">${Number(service.price || service.cost || 99).toFixed(2)}</span>
                  </div>
          ...
          {/* Vendor Details */}
          <div className="mt-16 sm:mt-20 bg-gradient-to-br from-gray-800/40 to-gray-900/60 border-2 border-gray-700/20 rounded-3xl p-6 sm:p-8 backdrop-blur-lg shadow-xl overflow-hidden">
            <div className="flex flex-col md:flex-row gap-6 sm:gap-8 items-center">
              ...
              <div className="flex-1 w-full">
                ...
                <p className="text-gray-400 mb-4">Professional since {new Date(vendor.createdAt || Date.now()).getFullYear()}</p>
          ...
          {/* Reviews Section */}
          <div className="mt-16 sm:mt-20 bg-gradient-to-br from-gray-800/40 to-gray-900/60 border-2 border-gray-700/20 rounded-3xl p-6 sm:p-8 backdrop-blur-lg shadow-xl">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gray-800/80 border-2 border-gray-700/30 rounded-2xl p-6 sm:p-8 max-w-md w-full backdrop-blur-lg shadow-2xl">
            <h3 className="text-xl font-bold text-white mb-6 flex items-center">
