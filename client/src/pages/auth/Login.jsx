...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const userData = isSignInActive
      ...
      : { name: signupName.trim(), email: signupEmail.trim(), password: signupPassword, role: signupRole };
      ...
      <div className="relative w-[768px] h-[480px] bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        >
          <div className="text-center text-white p-8">
            <h2 className="text-3xl font-bold mb-4">{isSignInActive ? 'Welcome Back!' : 'Hello, Friend!'}</h2>
            <p className="mb-6">
              {isSignInActive
